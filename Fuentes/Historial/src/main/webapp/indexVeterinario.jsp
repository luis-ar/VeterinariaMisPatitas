...
<html>
    ...
    <body>
        ...
        <script>
       const idVeterinario = ${idVeterinario}; // Recuperar el valor de Java y asignarlo a una variable de JavaScript
       localStorage.setItem('idVeterinario', idVeterinario); // Almacenar en localStorage
        </script>
    </body>
</html>
