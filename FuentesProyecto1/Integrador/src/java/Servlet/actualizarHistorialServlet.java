...
import dao.impl.DaoHistorialClinicoImpl;
...
public class actualizarHistorialServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        Integer idHistorial = Integer.valueOf(request.getParameter("idHistorial"));
        ...
        HistorialClinico cat = new HistorialClinico(idHistorial, codigoVeterinario, codigoMascota, fecha, descripcionSintomas, tratamiento);
        dao.historialUpd(cat);
