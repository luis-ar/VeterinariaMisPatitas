...
public class recuperarIDHistorialServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        response.setContentType("text/html;charset=UTF-8");
         Integer idHistorial = Integer.valueOf(request.getParameter("actualizar"));
        
        request.setAttribute("idHistorial", idHistorial);
        request.getRequestDispatcher("actualizarHistorialVeterinario.jsp").forward(request, response);
    }
